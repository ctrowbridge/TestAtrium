...
public class DefaultSpace {
  ...
  public void testDefaultSpace() throws Exception {
    ...
    // Open Side Menu
    driver.findElement(By.xpath("//div[@id='mini-panel-oa_toolbar_modern_panel']/div/div/div/div/div/div/div/span")).click();
    // Select Admin
    driver.findElement(By.xpath("//div[@id='toolbar-menu-button']/i")).click();
